...
\textbf{input} & \textbf{output} \\
	\midrule
\textbackslash eibar\{X\} & \eibar{X} \\
\textbackslash eiibar\{X\} & \eiibar{X} \\
\$\textbackslash overbar\{X\}\$ in math mode & $\overbar{X}$ \\
\end{tabular}
...
\noindent If you want to write preliminary margin notes,\rnote{This note is red.} you can use the command \texttt{\textbackslash rnote} for a red note.

The command \texttt{\textbackslash bnote} \bnote{This comment is blue.} lets you write blue notes.
